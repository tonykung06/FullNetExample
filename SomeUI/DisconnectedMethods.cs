...
namespace SomeUI
{
    internal static class DisconnectedMethods
    {
        ...
        {
            // even though the Id is there, the change tracker will still mark the records as "Added"
        ...
        // all objects without a Id will marked as "Added"
        ...
        // all objects with a Id will marked as "Unchanged"
